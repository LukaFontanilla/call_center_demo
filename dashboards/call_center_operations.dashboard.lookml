- dashboard: call_center_operations
  ...
  - title: Topics That Virtual Agents Solve Well
    ...
    totals_color: "#808080"
    y_axes: [{label: Messages w/o Live Agent, orientation: left, series: [{axisId: transcript__messages.percent_of_messages_without_live_agent,
        ...
        minValue: 0.75, unpinAxis: true, tickDensity: default, type: linear}, {label: !!null '',
        orientation: right, series: [{axisId: transcript__messages.total_call_time,
            id: transcript__messages.total_call_time, name: Total Call Time}], showLabels: true,
        showValues: true, minValue: 0.75, unpinAxis: true, tickDensity: default, type: linear}]
    size_by_field: transcript__messages.total_call_time
    series_types:
      conversation_topic_facts.average_conversation_length: scatter
      transcript__messages.total_call_time: scatter
    series_colors:
  ...
  - title: Areas Where Clients Are Happier with Live Agent
    ...
    show_silhouette: false
    totals_color: "#808080"
    y_axes: [{label: '', orientation: left, series: [{axisId: transcript__messages.average_sentiment,
    ...
    series_types: {}
    series_colors:
      Yes - transcript__messages.average_sentiment: "#FBB555"
      No - transcript__messages.average_sentiment: "#4276BE"
    series_labels:
  ...
  - title: Wait Time Tiers
    ...
    series_colors:
      Change Personal Information - transcript__messages.number_of_messages: "#4276BE"
      Credit Card - transcript__messages.number_of_messages: "#3EB0D5"
      Open a New Account - transcript__messages.number_of_messages: "#72D16D"
      Speak with an Advisor - transcript__messages.number_of_messages: "#FBB555"
      Submit a Fraud Alert - transcript__messages.number_of_messages: "#FFD95F"
    defaults_version: 1
    listen: {}
    row: 62
    col: 3
  ...
  - title: Common Undetected Phrases (4 Words)
    ...
    series_types:
      transcript__messages.average_sentiment: scatter
    series_colors:
  ...
  - title: Categories That Often Require Followup
    ...
    font_size: 10
    series_colors:
      Yes - transcript.count: "#4276BE"
      No - transcript.count: "#FBB555"
    series_labels:
  ...
  - title: Areas Where Calls Are Shorter with Live Agent
    ...
    y_axes: [{label: '', orientation: left, series: [{axisId: transcript.average_conversation_duration,
          ...
          {axisId: transcript.average_conversation_duration, id: Yes - transcript.average_conversation_duration,
            name: Live Agent}], showLabels: false, showValues: true, minValue: 3000,
        unpinAxis: false, tickDensity: default, tickDensityCustom: 5, type: linear}]
    series_types: {}
    series_colors:
      Yes - transcript__messages.average_sentiment: "#FBB555"
      No - transcript__messages.average_sentiment: "#4276BE"
      Yes - transcript.average_conversation_duration: "#FBB555"
      No - transcript.average_conversation_duration: "#4276BE"
    series_labels:
      Yes - transcript__messages.average_sentiment: Live Agent
      No - transcript__messages.average_sentiment: Virtual Agent
